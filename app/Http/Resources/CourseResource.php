...
class CourseResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'price' => $this->price,
            'is_favorite' => !$this->enrollments->isEmpty() ? $this->enrollments[0]['is_favorite'] : 0,
            'student_has_enrolled' => !$this->enrollments->isEmpty() ? $this->enrollments[0]['student_has_enrolled'] : 0,
